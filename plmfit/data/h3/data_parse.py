...
def filter_sequences(sequences, max_length=1000):
    """
...
def main():
    ...
    fasta_path = "H3_sequences.fasta"  # Path to your FASTA file
    ...
    filtered_data = filter_sequences(sequences)

    # Remove duplicate sequences
    unique_data = remove_duplicates(filtered_data)

    # Save the filtered and unique data to a CSV file
    csv_output_path = os.path.join(script_dir, "h3_data_full.csv")
