...
# Load the JSON files
with open('./results/aav_one_vs_many_progen2-small_lora_last_mean_linear_regression_metrics.json', 'r') as file:
    lora_data = json.load(file)

with open('./results/aav_one_vs_many_progen2-small_bottleneck_adapters_last_mean_linear_regression_metrics.json', 'r') as file:
    ada_data = json.load(file)

with open('./results/aav_one_vs_many_progen2-medium_feature_extraction_quarter3_mean_linear_regression_pred_vs_true.json', 'r') as file:
    fe_data = json.load(file)

with open('./results/aav_one_vs_many_mlp_regression_pred_vs_true.json', 'r') as file:
