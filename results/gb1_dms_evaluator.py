...
# Load the JSON files
with open('./results/gb1_one_vs_rest_progen2-small_lora_last_eos_linear_regression_metrics.json', 'r') as file:
    lora_data = json.load(file)

with open('./results/gb1_one_vs_rest_progen2-medium_bottleneck_adapters_quarter3_mean_linear_regression_metrics.json', 'r') as file:
    ada_data = json.load(file)

with open('./results/gb1_one_vs_rest_progen2-small_feature_extraction_quarter3_mean_linear_regression_pred_vs_true.json', 'r') as file:
    fe_data = json.load(file)

with open('./results/gb1_one_vs_rest_linear_regression_pred_vs_true.json', 'r') as file:
