...
#SBATCH --output=experiments/feature_extraction/config_%j/out.out
#SBATCH --error=experiments/feature_extraction/config_%j/error.err
...
python3 plmfit.py --function $1 --ft_method $2 \
        ...
        --optimizer ${13} --loss_f ${14} --embs $SCRATCH
