...
csv_file="./scripts/computational_analysis/experiments_setup.csv"
...
do
  ...
  sbatch --job-name="comp_anal_${data_type}_${plm}_${task}" \
         ...
         --time=$run_time:00:00 \
         scripts/computational_analysis/experiments_mass.sh \
