...
if __name__ == '__main__':  
    ...
    model.fine_tune('aav' , 'full_retrain' , epochs = 5 , lr = 0.001 , optimizer = 'adam' , batch_size = 8, train_split_name = 'two_vs_many_split', val_split = 0.2 , loss_f = 'mse' , log_interval = 1)
